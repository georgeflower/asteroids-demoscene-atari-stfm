...
- `src/st_text.c`: opaque 8x8 bitmap text for the planar screen (also at 2x), using `include/font_data.h` (generated by `tools/genfont.py`)
...
Not ported yet: power-ups, UFOs, aliens, bosses, chain combos, particles, sound, and Lovable's colour themes and starfield.
...
make screens-atari      # build/SCREENS.PRG: scripted walk through the banner, pause, game over, initials and title screens
